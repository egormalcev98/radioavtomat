				...
				<div class="direct-chat-contacts" style="background: #ffffff;">
					@if($chatStructuralUnits->isNotEmpty())
						<div class="form-group m-2">
							...
							<select class="form-control select2" style="width: 100%;" id="chat_structural_units" onchange="Chat.changeStructuralUnit($(this));">
					...
					@if($chatUsers->isNotEmpty())
						<div class="form-group m-2">
							...
							<select class="form-control select2" style="width: 100%;" id="chat_users" onchange="Chat.changeUser($(this));">
								<option value="" >Ничего не выбрано</option>
